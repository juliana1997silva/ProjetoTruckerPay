...
export default function pgtoSucessoQrCode({ navigation }){
                   ...
                   <View >
                    ...
                    <View style={{width:'100%',justifyContent:'center', alignItems:'center', paddingBottom:30}}>
                        ...
                        <TouchableOpacity style={{marginTop:10}}>
                            <Text style={{color:'#011e50', fontSize:16, fontWeight:'bold', textDecorationLine:'underline'}}> Compartilhar </Text>
                        </TouchableOpacity>
                    </View>
