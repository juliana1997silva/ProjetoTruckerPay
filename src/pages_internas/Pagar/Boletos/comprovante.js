            ...
            <View style={style.container}>
                ...
                borderBottomLeftRadius:10, borderBottomRightRadius:10, height:130}}>
                    ...
                    <View style={{ width:'100%', height:60, justifyContent:'center', shadowOffset:{width:0, height:1}, shadowColor:'#d3d3d3'}}>
                        <Text style={{color:'#011e50', fontSize:16, fontWeight:'bold', marginLeft:5}}> Confirme os dados para pagamento do boleto: </Text>
                    </View>
               ...
               <View style={style.body}>
                    ...
                    <View>
                        <TouchableOpacity style={style.btn} onPress={()=> navigation.navigate("Senha")}  >
