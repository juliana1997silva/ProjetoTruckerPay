    ...
    return(
            <View style={style.container}>
              ...
              <View style={style.body}>
                <Text style={style.textBody}> Sr(a),</Text>
                <Text style={style.textBody}> Informe seu nome completo: </Text>
                
                <TextInput placeholder='Nome Completo'  style={style.botao}/>
                <Text style={style.textInfo}> Sem abreviações</Text>
            ...
            <TouchableOpacity style={style.btnAvancar} onPress={() => navigation.navigate('DataNascimento')}>
